                ...
                <div class="row">
                    <div class="footer-widget col-lg-1 col-md-2 col-sm-2 col-xs-6  ml-auto  text-center ">
                        <div class="textwidget custom-html-widget">
                            <a href="https://www.oeaw.ac.at/acdh/acdh-ch-home"><img src="https://fundament.acdh.oeaw.ac.at/common-assets/images/acdh_logo.svg" class="image" alt="ACDH Logo" title="ACDH Logo"/></a>
                        </div>
                    </div>
                    <!-- .footer-widget -->
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="flex-md-row mb-4 align-items-center">
                                        <a href="https://www.fwf.ac.at/"><img class="card-img-right flex-auto d-md-block" src="img/fwf-logo_var2.png" alt="FWF Logo" title="FWF Logo" /></a>
                                    </div>
                                </div>  
                               <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="flex-md-row mb-4 align-items-center">
                                        <a href="https://orientalistik.univie.ac.at/">
                                            <img class="card-img-right flex-auto d-md-block" src="img/orient_wien.jpg" alt="Department of Near Eastern Studies Logo" title="Department of Near Eastern Studies Logo" /></a>
